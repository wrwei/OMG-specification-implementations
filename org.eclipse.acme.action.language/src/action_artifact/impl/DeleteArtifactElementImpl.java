 ...
 * </p>
 * <ul>
 *   <li>{@link action_artifact.impl.DeleteArtifactElementImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link action_artifact.impl.DeleteArtifactElementImpl#getArgumentationElement <em>Argumentation Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DeleteArtifactElementImpl extends DeleteImpl implements DeleteArtifactElement {
	...
	protected EClass eStaticClass() {
		return Action_artifactPackage.Literals.DELETE_ARTIFACT_ELEMENT;
	}
	...
	public void setIndex(int newIndex) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Action_artifactPackage.DELETE_ARTIFACT_ELEMENT__INDEX, oldIndex, index));
	}
	...
	public ArtifactElement getArgumentationElement() {
		if (argumentationElement != null && argumentationElement.eIsProxy()) {
			...
			if (argumentationElement != oldArgumentationElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Action_artifactPackage.DELETE_ARTIFACT_ELEMENT__ARGUMENTATION_ELEMENT, oldArgumentationElement, argumentationElement));
			}
		}
	...
	public void setArgumentationElement(ArtifactElement newArgumentationElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Action_artifactPackage.DELETE_ARTIFACT_ELEMENT__ARGUMENTATION_ELEMENT, oldArgumentationElement, argumentationElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Action_artifactPackage.DELETE_ARTIFACT_ELEMENT__INDEX:
				return getIndex();
			case Action_artifactPackage.DELETE_ARTIFACT_ELEMENT__ARGUMENTATION_ELEMENT:
