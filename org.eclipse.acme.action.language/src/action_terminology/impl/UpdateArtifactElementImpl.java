 ...
 * </p>
 * <ul>
 *   <li>{@link action_terminology.impl.UpdateArtifactElementImpl#getArgumentationElement <em>Argumentation Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UpdateArtifactElementImpl extends UpdateImpl implements UpdateArtifactElement {
	...
	protected EClass eStaticClass() {
		return Action_terminologyPackage.Literals.UPDATE_ARTIFACT_ELEMENT;
	}
		...
		if (argumentationElement != null && argumentationElement.eIsProxy()) {
			...
			if (argumentationElement != oldArgumentationElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Action_terminologyPackage.UPDATE_ARTIFACT_ELEMENT__ARGUMENTATION_ELEMENT, oldArgumentationElement, argumentationElement));
			}
		}
	...
	public void setArgumentationElement(ArtifactElement newArgumentationElement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Action_terminologyPackage.UPDATE_ARTIFACT_ELEMENT__ARGUMENTATION_ELEMENT, oldArgumentationElement, argumentationElement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Action_terminologyPackage.UPDATE_ARTIFACT_ELEMENT__ARGUMENTATION_ELEMENT:
