...
/**
 * This is the item provider adapter for a {@link action_argumentation.UpdateArgumentationElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateArgumentationElementItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdateArgumentationElementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateArgumentationElement_argumentationElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateArgumentationElement_argumentationElement_feature", "_UI_UpdateArgumentationElement_type"),
				 Action_argumentationPackage.Literals.UPDATE_ARGUMENTATION_ELEMENT__ARGUMENTATION_ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns UpdateArgumentationElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateArgumentationElement"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateArgumentationElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateArgumentationElement_type") :
			getString("_UI_UpdateArgumentationElement_type") + " " + label;
	}
