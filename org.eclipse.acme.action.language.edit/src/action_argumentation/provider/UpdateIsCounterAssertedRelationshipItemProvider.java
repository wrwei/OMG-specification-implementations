...
/**
 * This is the item provider adapter for a {@link action_argumentation.UpdateIsCounterAssertedRelationship} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateIsCounterAssertedRelationshipItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdateIsCounterAssertedRelationshipItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateIsCounterAssertedRelationship_isCounter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateIsCounterAssertedRelationship_isCounter_feature", "_UI_UpdateIsCounterAssertedRelationship_type"),
				 Action_argumentationPackage.Literals.UPDATE_IS_COUNTER_ASSERTED_RELATIONSHIP__IS_COUNTER,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns UpdateIsCounterAssertedRelationship.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateIsCounterAssertedRelationship"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateIsCounterAssertedRelationship)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateIsCounterAssertedRelationship_type") :
			getString("_UI_UpdateIsCounterAssertedRelationship_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UpdateIsCounterAssertedRelationship.class)) {
