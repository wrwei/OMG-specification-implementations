...
/**
 * This is the item provider adapter for a {@link action_argumentation.UpdateAssertedRelationshipTarget} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateAssertedRelationshipTargetItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdateAssertedRelationshipTargetItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateAssertedRelationshipTarget_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateAssertedRelationshipTarget_target_feature", "_UI_UpdateAssertedRelationshipTarget_type"),
				 Action_argumentationPackage.Literals.UPDATE_ASSERTED_RELATIONSHIP_TARGET__TARGET,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns UpdateAssertedRelationshipTarget.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateAssertedRelationshipTarget"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateAssertedRelationshipTarget)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateAssertedRelationshipTarget_type") :
			getString("_UI_UpdateAssertedRelationshipTarget_type") + " " + label;
	}
