...
/**
 * This is the item provider adapter for a {@link action_argumentation.ReferToArtifact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferToArtifactItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ReferToArtifactItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addReferredArtifactPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Referred Artifact feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addReferredArtifactPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferToArtifact_referredArtifact_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferToArtifact_referredArtifact_feature", "_UI_ReferToArtifact_type"),
				 Action_argumentationPackage.Literals.REFER_TO_ARTIFACT__REFERRED_ARTIFACT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns ReferToArtifact.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ReferToArtifact"));
	}
	...
	public String getText(Object object) {
		String label = ((ReferToArtifact)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ReferToArtifact_type") :
			getString("_UI_ReferToArtifact_type") + " " + label;
	}
