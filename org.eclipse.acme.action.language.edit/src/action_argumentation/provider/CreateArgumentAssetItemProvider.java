...
/**
 * This is the item provider adapter for a {@link action_argumentation.CreateArgumentAsset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CreateArgumentAssetItemProvider extends CreateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CreateArgumentAssetItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CreateArgumentAsset)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CreateArgumentAsset_type") :
			getString("_UI_CreateArgumentAsset_type") + " " + label;
	}
