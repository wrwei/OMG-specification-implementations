...
/**
 * This is the item provider adapter for a {@link action_argumentation.UpdateAssertedRelationshipSource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateAssertedRelationshipSourceItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdateAssertedRelationshipSourceItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateAssertedRelationshipSource_source_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateAssertedRelationshipSource_source_feature", "_UI_UpdateAssertedRelationshipSource_type"),
				 Action_argumentationPackage.Literals.UPDATE_ASSERTED_RELATIONSHIP_SOURCE__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns UpdateAssertedRelationshipSource.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateAssertedRelationshipSource"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateAssertedRelationshipSource)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateAssertedRelationshipSource_type") :
			getString("_UI_UpdateAssertedRelationshipSource_type") + " " + label;
	}
