...
/**
 * This is the item provider adapter for a {@link action_artifact.CreateArtifactAsset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CreateArtifactAssetItemProvider extends CreateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CreateArtifactAssetItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((CreateArtifactAsset)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CreateArtifactAsset_type") :
			getString("_UI_CreateArtifactAsset_type") + " " + label;
	}
