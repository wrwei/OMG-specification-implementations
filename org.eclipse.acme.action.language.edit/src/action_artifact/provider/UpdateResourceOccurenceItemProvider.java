...
/**
 * This is the item provider adapter for a {@link action_artifact.UpdateResourceOccurence} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateResourceOccurenceItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdateResourceOccurenceItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateResourceOccurence_occurence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateResourceOccurence_occurence_feature", "_UI_UpdateResourceOccurence_type"),
				 Action_artifactPackage.Literals.UPDATE_RESOURCE_OCCURENCE__OCCURENCE,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns UpdateResourceOccurence.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateResourceOccurence"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateResourceOccurence)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateResourceOccurence_type") :
			getString("_UI_UpdateResourceOccurence_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UpdateResourceOccurence.class)) {
