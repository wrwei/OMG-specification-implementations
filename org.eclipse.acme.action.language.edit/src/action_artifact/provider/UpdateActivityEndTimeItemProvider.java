...
/**
 * This is the item provider adapter for a {@link action_artifact.UpdateActivityEndTime} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateActivityEndTimeItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdateActivityEndTimeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateActivityEndTime_endTime_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateActivityEndTime_endTime_feature", "_UI_UpdateActivityEndTime_type"),
				 Action_artifactPackage.Literals.UPDATE_ACTIVITY_END_TIME__END_TIME,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns UpdateActivityEndTime.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateActivityEndTime"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateActivityEndTime)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateActivityEndTime_type") :
			getString("_UI_UpdateActivityEndTime_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UpdateActivityEndTime.class)) {
			case Action_artifactPackage.UPDATE_ACTIVITY_END_TIME__END_TIME:
