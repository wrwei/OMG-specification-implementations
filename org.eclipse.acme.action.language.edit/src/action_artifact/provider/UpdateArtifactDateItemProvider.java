...
/**
 * This is the item provider adapter for a {@link action_artifact.UpdateArtifactDate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateArtifactDateItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdateArtifactDateItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateArtifactDate_date_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateArtifactDate_date_feature", "_UI_UpdateArtifactDate_type"),
				 Action_artifactPackage.Literals.UPDATE_ARTIFACT_DATE__DATE,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns UpdateArtifactDate.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateArtifactDate"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateArtifactDate)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateArtifactDate_type") :
			getString("_UI_UpdateArtifactDate_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UpdateArtifactDate.class)) {
			case Action_artifactPackage.UPDATE_ARTIFACT_DATE__DATE:
