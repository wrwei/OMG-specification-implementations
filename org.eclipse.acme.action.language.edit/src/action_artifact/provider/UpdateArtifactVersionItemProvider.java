...
/**
 * This is the item provider adapter for a {@link action_artifact.UpdateArtifactVersion} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateArtifactVersionItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdateArtifactVersionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateArtifactVersion_version_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateArtifactVersion_version_feature", "_UI_UpdateArtifactVersion_type"),
				 Action_artifactPackage.Literals.UPDATE_ARTIFACT_VERSION__VERSION,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns UpdateArtifactVersion.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateArtifactVersion"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateArtifactVersion)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateArtifactVersion_type") :
			getString("_UI_UpdateArtifactVersion_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UpdateArtifactVersion.class)) {
			case Action_artifactPackage.UPDATE_ARTIFACT_VERSION__VERSION:
