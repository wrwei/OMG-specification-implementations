...
/**
 * This is the item provider adapter for a {@link action_assurancecase.UpdateAssuranceCaseElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateAssuranceCaseElementItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdateAssuranceCaseElementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateAssuranceCaseElement_argumentationElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateAssuranceCaseElement_argumentationElement_feature", "_UI_UpdateAssuranceCaseElement_type"),
				 Action_assurancecasePackage.Literals.UPDATE_ASSURANCE_CASE_ELEMENT__ARGUMENTATION_ELEMENT,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns UpdateAssuranceCaseElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateAssuranceCaseElement"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateAssuranceCaseElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateAssuranceCaseElement_type") :
			getString("_UI_UpdateAssuranceCaseElement_type") + " " + label;
	}
