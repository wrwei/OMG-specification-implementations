...
/**
 * This is the item provider adapter for a {@link action_terminology.UpdateTermOrigin} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateTermOriginItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdateTermOriginItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateTermOrigin_origin_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateTermOrigin_origin_feature", "_UI_UpdateTermOrigin_type"),
				 Action_terminologyPackage.Literals.UPDATE_TERM_ORIGIN__ORIGIN,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns UpdateTermOrigin.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateTermOrigin"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateTermOrigin)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateTermOrigin_type") :
			getString("_UI_UpdateTermOrigin_type") + " " + label;
	}
