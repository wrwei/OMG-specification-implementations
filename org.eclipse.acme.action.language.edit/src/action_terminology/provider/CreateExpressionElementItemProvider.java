...
/**
 * This is the item provider adapter for a {@link action_terminology.CreateExpressionElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CreateExpressionElementItemProvider extends CreateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CreateExpressionElementItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CreateExpressionElement_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CreateExpressionElement_value_feature", "_UI_CreateExpressionElement_type"),
				 Action_terminologyPackage.Literals.CREATE_EXPRESSION_ELEMENT__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((CreateExpressionElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CreateExpressionElement_type") :
			getString("_UI_CreateExpressionElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CreateExpressionElement.class)) {
			case Action_terminologyPackage.CREATE_EXPRESSION_ELEMENT__VALUE:
