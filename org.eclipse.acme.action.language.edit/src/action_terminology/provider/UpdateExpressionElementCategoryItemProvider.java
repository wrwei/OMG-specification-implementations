...
/**
 * This is the item provider adapter for a {@link action_terminology.UpdateExpressionElementCategory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UpdateExpressionElementCategoryItemProvider extends UpdateItemProvider {
	/**
	 ...
	 * @generated
	 */
	public UpdateExpressionElementCategoryItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UpdateExpressionElementCategory_category_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UpdateExpressionElementCategory_category_feature", "_UI_UpdateExpressionElementCategory_type"),
				 Action_terminologyPackage.Literals.UPDATE_EXPRESSION_ELEMENT_CATEGORY__CATEGORY,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns UpdateExpressionElementCategory.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/UpdateExpressionElementCategory"));
	}
	...
	public String getText(Object object) {
		String label = ((UpdateExpressionElementCategory)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UpdateExpressionElementCategory_type") :
			getString("_UI_UpdateExpressionElementCategory_type") + " " + label;
	}
